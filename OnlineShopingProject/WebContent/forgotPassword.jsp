...
<div id="container">
	<div class="signup">
		<form class="formclass" action="forgotPasswordAction.jsp" method="post">
		...
		<input class="txtbox" type="password" name="newpassword" placeholder="Enter your new Password" required><br>
		<input class="button-18" type="submit" Value="Save">
		</form>
